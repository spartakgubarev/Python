...
# n = int(input('Введите число N, выведу последовательость: '))
# i = 0
# count = 1
# while i < n:
#     print(count, end=' ')
...
str1 = 'Напишите программу, в которой пользователь будет задавать две строки, а программа - определять количество вхождений одной строки в другой.'
